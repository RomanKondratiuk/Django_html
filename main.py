...
<main>
    ...
    <div class="container">
            ...
            <div class="container">
                <div class="row text-center">
                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Оставьте заявку:</h2>
                                <form>
                                    <div class="mb-4">
        ...
        <div class="faq-section">
          ...
          <div class="faq-item">
              <button type="submit" class="btn btn-primary form-control">Как купить?</button>
            <div class="faq-answer">
              Ответ на вопрос "Как купить?" ...
            </div>
          </div>
          <div class="faq-item">
            <button type="submit" class="btn btn-primary form-control">Как доставить?</button>
            <div class="faq-answer">
              Ответ на вопрос "Как доставить?" ...
            </div>
          </div>
          <div class="faq-item">
            <button type="submit" class="btn btn-primary form-control">Какая гарантия?</button>
            <div class="faq-answer">
              Ответ на вопрос "Какая гарантия?" ...
            </div>
          </div>
        </div>
        </main>
...
<script>
    ...
    def do_GET(self):
        ...
        page_content = self.get__html_content()
